...
for managing schedulers and seed peers, offering http apis and portal, etc.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		// Initialize logger.
		if err := logger.InitManager(cfg.Verbose, cfg.Console, d.LogDir(), cfg.Server.LogRotateMaxSize, cfg.Server.LogRotateMaxBackups, cfg.Server.LogRotateMaxAge); err != nil {
