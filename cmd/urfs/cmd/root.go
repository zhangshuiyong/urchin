...
// Initialize default urchinfs config.
var cfg = config.NewDfstore()

var urfsDescription = `
urchinfs is a storage client for dragonfly. It can rely on different types of object storage,
such as S3 or OSS, to provide stable object storage capabilities.

urchinfs uses the entire P2P network as a cache when storing objects.
...
var rootCmd = &cobra.Command{
	Use:                "urfs <command> [flags]",
	Short:              "object storage client of urfs.",
	Long:               urfsDescription,
