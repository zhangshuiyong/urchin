...
// NewV1 returns the v2 grpc server instance and register service on grpc server.
func NewV1(svr schedulerv1.SchedulerServer, opts ...grpc.ServerOption) *grpc.Server {
